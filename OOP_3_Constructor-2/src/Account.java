public class Account {
    ...
    public Account(){ // constructor 1
       /* this.hesapNo = "Bilgi Yok";
        ...
        this("Bilgi Yok",0.0,"Bilgi Yok","Bilgi Yok","Bilgi Yok");// call constructor3


        //System.out.println("Kendi Yazdığımız Consttructor....");

    }
    public Account(String isim,String email,String telefonNo) { //constructor 2

        /*this.isim = isim; // 1
        this.email = email; // 2
        this.telefonNo = telefonNo; // 3

        this.bakiye = 0.0;
        this.hesapNo = "Bilgi Yok";*/

        this("Bilgi Yok",0.0,isim,email,telefonNo); // call constructor3


    }
    public Account(String hesapNo,double bakiye,String isim,String email,String telefonNo) { //constructor 3
